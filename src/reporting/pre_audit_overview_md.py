...
> This Pre-Audit Review provides structured guidance on how to interpret and act on the CRC Executive Pack and supporting module reports prior to a formal audit, regulatory review, or external assurance activity.

> It highlights potential payroll risk indicators identified through automated, data-driven checks. This document does not replace an audit, provide assurance, or constitute legal, accounting, or industrial relations advice.
...
This document does not independently analyse payroll data; it interprets the outputs generated by the CRC Executive Pack and detailed module reports.
...
1. Refer to the **CRC Executive Pack** for severity distributions, thematic patterns and prioritisation guidance.
...
Refer to the **CRC Executive Pack** for severity distributions, thematic patterns and prioritisation guidance.
---
...
This Pre-Audit Review should be read together with the **CRC Executive Pack**. The Executive Pack contains the structured findings and severity analysis; this document provides governance-focused guidance on how to use those outputs in preparation for audit activity.
