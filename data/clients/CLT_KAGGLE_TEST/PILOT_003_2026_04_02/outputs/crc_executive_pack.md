...
**Report prepared as at:** 05 Apr 2026  
...
- High-severity findings are concentrated in TERM and RKEG, indicating the strongest exposure sits in those areas.
...
Prioritise detailed review of TERM and RKEG first, then address structural data gaps that may weaken evidentiary confidence.
...
|---|---:|
| Total findings | 109 |
| Dominant classification | LOGICAL |
| Dominant severity | HIGH |
| Logical findings | 63 |
| Structural findings | 37 |
| Contextual findings | 9 |
| High severity findings | 63 |
| Medium severity findings | 46 |
...
### 3.2 **Long Service Leave (LSL) Exposure – Scope & Methodology**
...
### 3.4 **Record-Keeping & Evidence Gaps (RKEG) – Scope & Methodology**
...
## 5. Module Summary Overview



### 5.1 Leave & Entitlement Leakage (LEAVE) – Summary Overview
...
### 5.2 Long Service Leave (LSL) Exposure – Severity Overview



### 5.3 Termination Exposure – Severity Overview
...
| Severity | Count | Description |
|---------|:-------------:|---------------------------|
| <span class="badge-high">High</span>    | 21   | Absence or weakness of core termination or final pay evidence that would materially impair the organisation’s ability to evidence termination decisions if reviewed by auditors or regulators. |
| <span class="badge-medium">Medium</span>  | 9 | Termination evidence exists but is incomplete, delayed or ambiguous and may require additional explanation or manual reconstruction. |
| <span class="badge-low">Low</span>     | 0    | Minor record-keeping or data quality weaknesses in termination records that should be improved over time to support efficient and reliable payroll operations. |

---

### 5.4 Record-Keeping & Evidence Gaps (RKEG) – Severity Overview
...
| Severity | Count | Description |
|----------|:-----:|-------------|
| <span class="badge-high">High</span> | 18 | Absence or weakness of core evidence or entitlement configuration that would materially impair the organisation’s ability to evidence payroll decisions if reviewed by auditors or regulators. |
| <span class="badge-medium">Medium</span> | 31 | Evidence is incomplete, inconsistent or fragile. Decisions may still be defensible but require greater reliance on manual reconstruction, judgement, or explanation. |
| <span class="badge-low">Low</span> | 0 | Record-keeping or data quality weaknesses that are unlikely to be challenged in isolation but should be improved over time to support efficient and reliable payroll operations. |

### 5.5 How to interpret findings
...
1. Prioritise detailed review of termination handling and record-keeping and evidence controls first, as these areas show the strongest concentration of high-severity findings.
